...
export default class EatPage extends Component {
    ...
    componentDidMount() {
        axios.get('//caffeinate-and-dominate.herokuapp.com/meals/')
        .then(response => {
    ...
    handleDelete(e,id){
        e.preventDefault();
        axios.delete('//caffeinate-and-dominate.herokuapp.com/meals/delete/'+id)
    ...
    saveMeal(e){
        ...
        axios.post('//caffeinate-and-dominate.herokuapp.com/meals/add', newMeal)
