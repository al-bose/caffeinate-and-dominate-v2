...
export default class EditWorkout extends Component {
    ...
    componentDidMount() {
        ...
        onSubmit(e) {
            ...
            axios.post('http://localhost:4000/workouts/update/'+this.props.match.params.id, newWorkout)
                .then(res => console.log(res.data));


            this.props.history.push('/features/workout');
        }
            ...
            return (
                ...
                <section className='inner row justify-content-center align-items-center text-center' style ={{height: '100%'}}>
                  <div className = 'col align-items-end'>
                    <h3 className='text-white'>Edit Workout</h3>
                    <form onSubmit={this.onSubmit}>
                        ...
                        <h5 className='text-white'>Edit Exercises</h5>
                        {this.state.exercises.map(function(currentExercise,i){
                            ...
                            <input type="submit" value="Save Changes" className="btn btn-dark" />
                        </div>
                    </form>
                    </div>
                    </section>
